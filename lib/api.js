...
export const keywordApi = {
  ...
  create: (storeId, { keyword, label = undefined }) =>
    api.post(`/stores/${storeId}/keywords`, { keyword, label }),

  update: (storeId, keywordId, payload) =>
    api.patch(`/stores/${storeId}/keywords/${keywordId}`, payload),

  delete: (storeId, keywordId) =>
    api.delete(`/stores/${storeId}/keywords/${keywordId}`),
};
